...
/** Die Commands, die eine [[History]] beitraegt.
  *
  * Werte, keine Namen (§12): Dispatch laeuft ueber Objektidentitaet, nicht ueber einen String. Wer
  * sie an eine Taste bindet -- das tut `ember-browser-support` ab P22 --, dispatcht diese beiden
  * und nicht `"undo"`.
  *
