...
<div id="root"></div>
<script type="module">
import { emberFixtures, runtimeFixtures, projectionFixtures, formFixtures, selectionFixtures, editingFixtures, clipboardFixtures, mediaFixtures, highlightFixtures, editorBench } from '/main.js'
